...
<section class="user-area">
    <div class="container">
        <div class="user-form-content">
            ...
            <p>Fill up the form below to reset your password</p>

            <form class="user-form" action="{{route('auth.resetPassword')}}" method="post"
            id="passwordRest">
                @csrf
                <div class="row">
...
<script src="{{asset('dashboard/js/requests/auth/account_recovery.js')}}"></script>
