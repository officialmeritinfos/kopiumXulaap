                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item" href="#editBranch" data-bs-toggle="modal"
                                                   data-value="{{$term->id}}" data-name="{{$term->name}}"
                                                   data-branch="{{$term->branch}}">
                                                    Edit
                                            ...
                                            @if($term->status==1)
                                                <li>
                                                    <a class="dropdown-item " href="{{route('user.school.term.status.edit',['ref'=>$term->reference,'type'=>'deactivate'])}}">
                                                        Deactivate
                                                        <i class="fa fa-ban"></i>
                                                    </a>
                                                </li>
                                            @else
                                                <li>
                                                    <a class="dropdown-item" href="{{route('user.school.term.status.edit',['ref'=>$term->reference,'type'=>'activate'])}}">
                                                        Activate
                                            ...
                                            @endif
                                            <li>
                                                <a class="dropdown-item" href="{{route('user.school.term.delete',['slug'=>$school->slug,'ref'=>$term->reference])}}">
                                                    Delete
    ...
    @push('js')
        ...
        <div class="modal fade" id="editBranch" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Edit Academic term</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">
                            <div>
                                <form class="row g-3 submit-property-form product-upload shadow-none" method="post"
                                      action="{{route('user.school.term.edit')}}"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12" style="display: none;">
                                            <label for="inputState" class="form-label">term Id</label>
